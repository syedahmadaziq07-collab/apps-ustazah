...
VALUES
  ...
  ('dua-8', 'Doa Masuk Rumah', 'بِسْمِ اللهِ وَلَجْنَا وَبِسْمِ اللهِ خَرَجْنَا وَعَلَى اللهِ رَبِّنَا تَوَكَّلْنَا', 'Bismillahi walajna wa bismillahi kharajna wa ''alallahi rabbina tawakkalna', 'Dengan nama Allah kami masuk, dengan nama Allah kami keluar, dan kepada Allah Tuhan kami bertawakal.', '', '/audio/arabic/doa-tenang.mp3', '🏠', 'Baca doa ini sebelum masuk rumah.', 'doa', 7, true),
  ('dua-9', 'Doa Keluar Rumah', 'بِسْمِ اللهِ تَوَكَّلْتُ عَلَى اللهِ لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللهِ', 'Bismillahi tawakkaltu ''alallahi la haula wa la quwwata illa billah', 'Dengan nama Allah, aku bertawakal kepada Allah. Tiada daya dan kekuatan melainkan dengan Allah.', '', '/audio/arabic/hasbunallah.mp3', '🚪', 'Baca doa ini sebelum keluar rumah.', 'doa', 8, true),
  ('dua-10', 'Doa Untuk Ibu Bapa', 'رَبِّ ارْحَمْهُمَا كَمَا رَبَّيَانِي صَغِيرًا', 'Rabbirhamhuma kama rabbayani saghira', 'Ya Allah, sayangilah kedua ibu bapaku sebagaimana mereka menyayangiku semasa kecil.', '', '/audio/arabic/doa-tenang.mp3', '👨‍👩‍👧‍👦', 'Baca doa ini untuk kedua ibu bapa.', 'doa', 9, true),
  ('dua-11', 'Doa Masuk Masjid', 'اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ', 'Allahummaftah li abwaba rahmatik', 'Ya Allah, bukakanlah untukku pintu-pintu rahmat-Mu.', '', '', '🕌', 'Baca doa ini semasa masuk masjid.', 'doa', 10, true),
  ('dua-12', 'Doa Keluar Masjid', 'اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكَ', 'Allahumma inni asaluka min fadlik', 'Ya Allah, aku memohon kurnia-Mu.', '', '', '🕌', 'Baca doa ini semasa keluar masjid.', 'doa', 11, true),
  ('dua-13', 'Doa Belajar', 'رَبِّ زِدْنِي عِلْمًا وَارْزُقْنِي فَهْمًا', 'Rabbi zidni ''ilman warzuqni fahma', 'Ya Tuhanku, tambahkanlah ilmu dan berikanlah aku kefahaman.', '', '/audio/arabic/doa-kekuatan.mp3', '📚', 'Baca doa ini sebelum belajar.', 'doa', 12, true),
  ('dua-14', 'Doa Bersyukur', 'رَبِّ أَوْزِعْنِي أَنْ أَشْكُرَ نِعْمَتَكَ الَّتِي أَنْعَمْتَ عَلَيَّ', 'Rabbi awzi''ni an asykura ni''matakallati an''amta ''alayya', 'Ya Tuhanku, ilhamkanlah aku untuk mensyukuri nikmat-Mu yang telah Engkau berikan kepadaku.', '', '/audio/arabic/alhamdulillah.mp3', '🙏', 'Baca doa ini sebagai tanda syukur.', 'doa', 13, true),
  ('dua-15', 'Doa Mohon Kekuatan', 'رَبَّنَا أَفْرِغْ عَلَيْنَا صَبْرًا وَثَبِّتْ أَقْدَامَنَا', 'Rabbana afrigh ''alayna sabran wa tsabbit aqdamana', 'Ya Tuhan kami, limpahkanlah kesabaran kepada kami dan teguhkanlah pendirian kami.', '', '/audio/arabic/doa-kekuatan.mp3', '💪', 'Baca doa ini minta kekuatan hati.', 'doa', 14, true),
  -- Zikir
  ('istighfar', 'Istighfar', 'أَسْتَغْفِرُ اللهَ', 'Astaghfirullah', 'Aku memohon ampun kepada Allah.', '', '/audio/arabic/istighfar.mp3', '🤲', 'Memohon ampun dan kelapangan hati daripada Allah SWT.', 'zikir', 15, true),
  ('alhamdulillah', 'Alhamdulillah', 'الْحَمْدُ لِلّٰهِ', 'Alhamdulillah', 'Segala puji bagi Allah.', '', '/audio/arabic/alhamdulillah.mp3', '💫', 'Zikir bersyukur kepada Allah atas segala nikmat kebaikan.', 'zikir', 16, true),
  ('subhanallah', 'Subhanallah', 'سُبْحَانَ اللهِ', 'Subhanallah', 'Maha Suci Allah.', '', '/audio/arabic/subhanallah.mp3', '⭐', 'Zikir mensucikan Allah daripada segala kekurangan.', 'zikir', 17, true),
  ('hasbunallah', 'Hasbunallah', 'حَسْبُنَا اللهُ وَنِعْمَ الْوَكِيلُ', 'Hasbunallah wa ni''mal wakil', 'Cukuplah Allah bagiku dan sebaik-baik tempat berserah.', '', '/audio/arabic/hasbunallah.mp3', '🛡️', 'Zikir tawakal dan penyerahan diri kepada Allah.', 'zikir', 18, true),
  ('bismillah', 'Bismillah', 'بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيمِ', 'Bismillahirrahmanirrahim', 'Dengan nama Allah Yang Maha Pemurah lagi Maha Penyayang.', '', '/audio/arabic/bismillah.mp3', '🌙', 'Ucapkan Bismillah sebelum memulakan sesuatu.', 'zikir', 19, true)
-- ============================================
