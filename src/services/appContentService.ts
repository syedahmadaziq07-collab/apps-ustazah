...
const DEFAULT_PAGES: Record<string, AppPage> = {
  home: {
    ...
    subtitle: 'Pilih emosi yang kamu rasa sekarang untuk bertenang bersama i-Qalb Care.',
    body_text: '',
  ...
  profile: {
    ...
    page_name: 'profile',
    title: 'Profil App',
    subtitle: 'i-Qalb Care membantu murid mengenal emosi dan mengamalkan cara bertenang secara Islam.',
    body_text: 'Aplikasi i-Qalb Care: Tenang Bersama Islam direka khas sebagai instrumen bantuan digital untuk pengamal kaunseling sekolah dalam mengendalikan terapi intervensi emosi murid.',
    image_url: '',
    audio_url: '',
    content_json: {
      schoolInfo: 'SK Seri Idaman, Shah Alam, Selangor',
      counsellingNote: 'i-Qalb Care menyusun peralihan kognitif negatif kepada gema zikrullah untuk menstabilkan kondisi psikologi murid.',
